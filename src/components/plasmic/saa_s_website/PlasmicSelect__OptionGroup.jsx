...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: hj_vpRwWkOieJ7r/css
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option___1Gsbf)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__caXa0)}
              />
            </React.Fragment>
          ),
