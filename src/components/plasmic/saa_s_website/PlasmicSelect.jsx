...
import Select__Overlay from "../../Select__Overlay"; // plasmic-import: LTqZOt_6aguEqsC/component
import Select__Option from "../../Select__Option"; // plasmic-import: MmGWtny_wrGHQBY/component
import Select__OptionGroup from "../../Select__OptionGroup"; // plasmic-import: hj_vpRwWkOieJ7r/component
import "@plasmicapp/react-web/lib/plasmic.css";
import projectcss from "./plasmic_saa_s_website.module.css"; // plasmic-import: kHCKEcYWcmWFvnZ511qGxj/projectcss
import sty from "./PlasmicSelect.module.css"; // plasmic-import: wskXIbW-ncLJHKm/css
import ChevronDownsvgIcon from "./icons/PlasmicIcon__ChevronDownsvg"; // plasmic-import: X8JZvPQpwoCL3Kz/icon
import ChevronUpsvgIcon from "./icons/PlasmicIcon__ChevronUpsvg"; // plasmic-import: rENJBLe0su-zTkK/icon
    ...
    if (!("children" in props)) {
      props = {
        ...
        children: (
          <React.Fragment>
            <Select__Option
              className={classNames("__wab_instance", sty.option__bVwCq)}
              value={"value1"}
            >
              {"Option 1"}
            </Select__Option>
            <Select__Option
              className={classNames("__wab_instance", sty.option___7BfRu)}
              value={"value2"}
            >
              {"Option 2"}
            </Select__Option>
