...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: gT-pc3PmJGII6xG/css
import SearchsvgIcon from "./icons/PlasmicIcon__Searchsvg"; // plasmic-import: VKO-xBA0-WbjHL9/icon
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: 2gocWyQdTDTPjMf/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <SearchsvgIcon
                className={classNames(projectcss.all, sty.svg__gkG08)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__twlsH)}
                role={"img"}
              />
            ),
